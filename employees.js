...
class Employee {
    ...
    getSchedule (){
        console.log(`${this.name} woeks on ${this.shifts}`)
    }
}
...
//CODE HERE
const empOne = new Employee(`Yuna`,`Weekend mornings, Weekday afternoons`)
/*
...
const manager = new Manager(`Tristan`,`Weekdays`,[`Yuna`, `Nikita`])
...
//CODE HERE 
manager.addEmployee(`Red`)
manager.addEmployee(`Kelseir`)
manager.addEmployee(`Vin`)
/*
    Call the `getEmployees` method on the
