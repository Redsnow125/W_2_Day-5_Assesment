...
const canWeDeliver = (zipCode) =>{
    for(i = 0; i < deliveryAreaZipCodes.length; i++){
        if(zipCode === deliveryAreaZipCodes[i]){
            return console.log(`We can deliver to your zipcode! Zip: ${zipCode}\n`);
        }
       return console.log(`Sorry we cannot deliver to your zipcode. Zip: ${zipCode}\n`);
    }
}
canWeDeliver(84606) 
canWeDeliver(85205) 
