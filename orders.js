...
class Ticket{
    ...
    updatestatus (newStatus){
        ...
        console.log(`The customer status for ${this.customerId} is now ${this.status}`)
    }
}
...
//CODE HERE
const firstTicket = new Ticket(`treats,dog bed, and kibble`,`3:33 AM`,101)
...
//CODE HERE
firstTicket.updatestatus(`Bagging`)